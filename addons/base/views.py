...
def webmeetings_get_config_ember(**kwargs):
    ...
    if microsoft_teams_auth:
        ...
        qsnodeMicrosoftTeamsAttendees = microsoft_teams.Attendees.objects.filter(Q(node_settings_id=microsoft_teams_addon.id, external_account_id=microsoft_teams_addon.external_account_id) | Q(node_settings_id=microsoft_teams_addon.id, external_account_id=None))
    ...
    if webex_meetings_auth:
        ...
        qsnodeWebexMeetingsAttendees = webex_meetings.Attendees.objects.filter(Q(node_settings_id=webex_meetings_addon.id, external_account_id=webex_meetings_addon.external_account_id) | Q(node_settings_id=webex_meetings_addon.id, external_account_id=None))
