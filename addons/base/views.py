...
def webmeetings_get_config_ember(**kwargs):
    ...
    if webex_meetings_auth:
        ...
        qsNodeWebexMeetingsAttendeesRelation = webex_meetings.MeetingsAttendeesRelation.objects.filter(meeting__node_settings_id=webex_meetings_addon.id, external_account_id=webex_meetings_addon.external_account_id)
