...
var logPrefix = '[microsoftteams] ';

require('./microsoftteams.css');


function MicrosoftTeamsWidget() {
    var self = this;
    self.baseUrl = window.contextVars.node.urls.api + 'microsoftteams/';
...
osfHelpers.applyBindings(w, '#microsoftteams-content');
w.loadConfig();
