        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>${ _("Queries") }</h4>
                    <p>${ _("Search uses the <a href=%s>Lucene search syntax</a>.", '"http://extensions.xwiki.org/xwiki/bin/view/Extension/Search+Application+Query+Syntax"') }${ _("This gives you many options, but can be very simple as well. Examples of valid searches include:") }</p>
                    <ul>
