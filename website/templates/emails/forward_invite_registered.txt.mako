...
You have been added by ${referrer.fullname} as a contributor to the project "${node.title}" on the GakuNin RDM. To claim yourself as a contributor to the project, visit this url:
