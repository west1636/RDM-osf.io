...
<head>
    ...
    <title>NIIメール通知テンプレート / NII Email Notification Template</title>
        ...
        <td style="border-collapse: collapse;">
            <table id="content" width="600" border="0" cellpadding="25" cellspacing="0" align="center" style="margin: 30px auto 0 auto;background: white;box-shadow: 0 0 2px #ccc;">
                <tbody>
                    <tr>
                        <td style="border-collapse: collapse;">
                            <h3 class="text-center" style="padding: 0;margin: 0;border: none;list-style: none;font-weight: 300;text-align: center;">最近の活動</h3>
                        ...
                        <th colspan="2" style="padding: 0px 15px 0 15px">
                            <h3 style="padding: 0 15px 5px 15px; margin: 30px 0 0 0;border: none;list-style: none;font-weight: 300; border-bottom: 1px solid #eee; text-align: left;">
                              %if destination_node.parent_node:
                                <small style="font-size: 14px;color: #999;">${destination_node.parent_node.title} の</small>
                              %endif
                ...
                <tbody>
                    <tr>
                        <td style="border-collapse: collapse;">
                          The ${u'フォルダ' if source_path.endswith('/') else u'ファイル'} (${source_path.strip('/')}) が ${source_node.title} の ${source_addon} から ${destination_addon} へ正常に ${u'移動' if action == 'move' else u'コピー'}されました。
                        </td>
                    </tr>
                    <tr>
                        <td style="border-collapse: collapse;">
        ...
        <td style="border-collapse: collapse; padding-top: 15px;">
            <table width="80%" border="0" cellpadding="10" cellspacing="0" align="center" class="footer" style="margin-top: 45px;padding: 25px 0 35px;background-color: rgb(244, 244, 244);border-top: 1px solid #E5E5E5;border-bottom: 1px solid #E5E5E5;width: 100%;color: #555;">
                <tbody>
                    <tr>
                        <td style="border-collapse: collapse;">
                            <p class="small text-center" style="text-align: center;font-size: 12px;">Copyright &copy; 2016-2020 国立情報学研究所 |
                                    <a href="https://meatwiki.nii.ac.jp/confluence/pages/viewpage.action?pageId=32676422">プライバシーポリシー</a></p>
                            <p class="text-smaller text-center" style="text-align: center;font-size: 12px;">〒101-8430 東京都千代田区一ツ橋2-1-2</p>
                            <p class="small text-center" style="text-align: center;font-size: 12px;">Copyright &copy; 2016-2020 National Institute of Informatics, All rights reserved. |
