        ...
        <td style="border-collapse: collapse;">
            <table id="content" width="600" border="0" cellpadding="25" cellspacing="0" align="center" style="margin: 30px auto 0 auto;background: white;box-shadow: 0 0 2px #ccc;">
                ...
                <tbody>
                    <tr>
                        <td style="border-collapse: collapse;">
                          エラーが発生し、GakuNin RDMの$ {source_node.title}からの${u'フォルダ' if source_path.endswith('/') else u'ファイル'}が正常に${u'移動' if action == 'move' else u'コピー'}されませんでした。
                          ログインして、このアクションを再試行してください。 問題が解決しない場合は、 ${osf_contact_email} にメールを送信してください。
                        </td>
                    </tr>
                    <tr>
                        <td style="border-collapse: collapse;">
                          ...
                          Please log in and try this action again. If the problem persists, please email ${osf_contact_email}.
                        </td>
                    </tr>
                </tbody>
            </table>
