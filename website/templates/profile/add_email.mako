		...
		<div style="visibility:hidden; display:none;">
                <div id="externalIdentity" class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        ${ _("You have not authorized any external services to log in to the GakuNin RDM.") }</p>
                        % endif
                        <tbody>
                ...
                <div id="deactivateAccount" class="panel panel-default">
                    ...
                    <div class="panel-body">
                        %if not requested_deactivation:
                            <p class="alert alert-warning"><strong>Warning:</strong> ${ _("This action is irreversible.") }</p>
                        %endif
