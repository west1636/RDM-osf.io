...
<%def name="title()">${ _("Withdraw Registration of Component") }</%def>

<legend class="text-center">${ _("Withdraw Registration") }</legend>
    ...
    <div id="registrationRetraction" class="col-md-6 col-md-offset-3">
        ...
        <form id="registrationRetractionForm" role="form">
            ...
            <div class="form-group">
                <label class="control-label">${ _("Please provide your justification for withdrawing this registration.") }</label>
                <textarea
                        class="form-control"
            ...
            <div class="form-group">
                <label style="font-weight:normal" class="control-label">
                    ${ _('Type <span data-bind="text: confirmationString" style="font-weight:bold"></span> and click Withdraw Registration if you are sure you want to continue.') }
                </label>
                <input  type="text"
                        class="form-control"
            ...
            <button type="submit" class="btn btn-danger" data-bind="click: submit, css: {disabled: !valid()}">${ _("Withdraw Registration") }</button>
