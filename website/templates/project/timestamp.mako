                    ...
                    <table class="table table-bordered table-addon-terms">
                        <thead class="block-head">
                            <tr>
                                ...
                                <th width="10%"><span id="sort_provider">Provider</span></th>
                                <th width="30%"><span id="sort_file_path">File Path</span></th>
                                <th width="15%"><span id="sort_verify_user_name_id">Timestamp by</span></th>
                                <th width="22%"><span id="sort_verify_date">Updated at</span></th>
                                <th width="20%"><span id="sort_verify_result_title">Timestamp Verification</span></th>
                            </tr>
                        </thead>
                        <font color="red">
