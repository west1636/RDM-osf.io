                    ...
                    <table class="table table-bordered table-addon-terms">
                        <thead class="block-head">
                            <tr>
                                ...
                                <th width="11%">Provider <span id="sort_up_provider" class="fa fa-chevron-up text-faded"></span><span id="sort_down_provider" class="fa fa-chevron-down text-faded"></span></th>
                                <th width="29%">File Path <span id="sort_up_file_path" class="fa fa-chevron-up text-faded"></span><span id="sort_down_file_path" class="fa fa-chevron-down text-faded"></span></th>
                                <th width="15%">Timestamp by <span id="sort_up_verify_user_name_id" class="fa fa-chevron-up text-faded"></span><span id="sort_down_verify_user_name_id" class="fa fa-chevron-down text-faded"></span></th>
                                <th width="22%">Updated at <span id="sort_up_verify_date" class="fa fa-chevron-up text-faded"></span><span id="sort_down_verify_date" class="fa fa-chevron-down text-faded"></span></th>
                                <th width="20%">Timestamp Verification <span id="sort_up_verify_result_title" class="fa fa-chevron-up text-faded"></span><span id="sort_down_verify_result_title" class="fa fa-chevron-down text-faded"></span></th>
                            </tr>
                        </thead>
                        <font color="red">
