...
<div class="row">
    ...
    <p>${ _("Hello %s !", firstname) } ${ _("Please set a password to claim your account.") }</p>
    <p>${ _("E-mail:") } <strong>${ email }</strong></p>
        ...
        >
            ...
            <div class="form-group">
                    ...
                    <label style="margin-right: 15px">${ _("I have read and agree to the <a %s>Terms of Use</a> and <a %s>Privacy Policy</a>.", 'target="_blank" href="https://meatwiki.nii.ac.jp/confluence/pages/viewpage.action?pageId=32676419"', 'target="_blank" href="https://meatwiki.nii.ac.jp/confluence/pages/viewpage.action?pageId=32676422"') }</label>
            ...
            <div class='help-block'>
                <p>${ _("If you are not %s or if you were erroneously added as a contributor to the project described in the email invitation, please email", fullname) } <a href="mailto:${osf_contact_email}">${osf_contact_email}</a>
                </p>
            </div>
