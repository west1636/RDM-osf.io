            ...
            <form data-bind="submit: submit" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="pull-right">
                        ...
                        <label style="margin-right: 15px">${ _("I have read and agree to the <a %(term_of_use)s>Terms of Use</a> and <a %(privacy_policy)s>Privacy Policy</a>.", term_of_use="target=\"_blank\" href=\"https://meatwiki.nii.ac.jp/confluence/pages/viewpage.action?pageId=32676419\"", privacy_policy="target=\"_blank\" href=\"https://meatwiki.nii.ac.jp/confluence/pages/viewpage.action?pageId=32676422\"") }</label>
